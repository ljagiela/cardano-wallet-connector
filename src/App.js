  ...
  constructor(props) {
    ...
    this.state = {
      ...
      addressBech32SendADA:
        "addr_test1qp7vynpwhsyjsqvyw9n8r4uy3uj5hu2arfy94vynvng6556hhqrnhndmg2pntqazt36v700x6kryqjhe75p58v65v6kszx7h3j",
      lovelaceToSend: 3000000,
      assetNameHex: "4c616365436f696e32",
      assetPolicyIdHex:
        "6b728428c0eb014949d72c94449bbef4b10b6ad2b1b86bd4e92476f0",
      assetAmountToSend: 2,
      addressScriptBech32:
    ...
    return (
      <div style={{ margin: "20px" }}>
        ...
        <p>
          ...
          <span data-testid="wallet-api-version">
        ...
        <button
          ...
          data-testid="sign-data-run-button"
        >
          Sign data
        </button>
        ...
        >
            ...
            panel={
              <div style={{ marginLeft: "20px" }}>
                ...
                <button
                  ...
                  data-testid="send-ada-run-button"
                >
                  Run
                </button>
              </div>
            ...
            panel={
              <div style={{ marginLeft: "20px" }}>
                ...
                <button
                  ...
                  data-testid="send-token-run-button"
                >
                  Run
                </button>
              </div>
            ...
            panel={
              <div style={{ marginLeft: "20px" }}>
                ...
                <button
                  ...
                  data-testid="send-ada-to-plutus-run-button"
                >
                  Run
                </button>
              </div>
            ...
            panel={
              <div style={{ marginLeft: "20px" }}>
                ...
                <button
                  ...
                  data-testid="send-token-to-plutus-run-button"
                >
                  Run
                </button>
              </div>
            ...
            panel={
              <div style={{ marginLeft: "20px" }}>
                ...
                <button
                  ...
                  data-testid="redeem-ada-from-plutus-run-button"
                >
                  Run
                </button>
          ...
          <Tab
            ...
            data-testid="redeem-token-plutus"
            panel={
              <div style={{ marginLeft: "20px" }}>
                <FormGroup
                  helperText="Script address where ADA is locked ..."
                ...
                <button
                  ...
                  data-testid="redeem-token-from-plutus-run-button"
                >
                  Run
                </button>
              </div>
